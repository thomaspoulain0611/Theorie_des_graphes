...
void menu( std::string& commande, std::string& fichier, std::string& fichierpoids, int& nom, int& poids, int& cdn, int& cd,int& cvp, int& cpn, int& cp,int& ci, int& ciN, int& cia, std::vector<int>& id, std::vector<int>& id2, int& taille, int& taille2, int& idArete, int& idArete2)
{
    ...
    else if(commande=="dessiner")
    {
        ...
        cia=0;
        nom=0;
        a.dessinerTous(nom, poids, cdn, cd, cvp, cp, cpn, ci, ciN, cia);//Appel fonction pour dessiner
        SetConsoleTextAttribute(hConsole, 14);
    ...
    {
        a.centralitevp();//Appel fonction qui calcule la centralite vecteur propre
        a.centralitedegre();//Appel fonction qui calcule la centralite de degre
        a.centralitedegreN();//Appel fonction qui calcule la centralite de degre normalise
        a.centraliteproxi();//Appel fonction qui calcule la centralite de proximite
        a.centraliteproxiN();//Appel fonction qui calcule la centralite de proximite nomarlise
        a.centraliteinter();//Appel fonction qui calcule la centralite d'intermediarite
        a.centraliteinterN();//Appel fonction qui calcule la centralite d'intermediarite normalise
        a.centraliteinterarete();//Appel fonction qui calcule la centralite d'intermediarite pour les aretes
        a.recupcpg();//Appel fonction qui calcule la centralite globale proxi
        a.affichercentralite();//Appel fonction qui affiche toutes les centralites
